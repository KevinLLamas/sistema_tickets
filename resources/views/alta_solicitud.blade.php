    ...
    <form class="container mb-5" id="alumno" v-on:submit.prevent="guardar()">
        ...
        <div class="row">
            ...
            <div class="form-group col-6" v-if="solicitud.categoria != ''">
                ...
                <select class="form-control" name="subcategoria" id="subcategoria" v-model="solicitud.subcategoria" @change="mostrar_inputs()" required>
                    <option value="" selected="selected" disabled>Selecciona</option>
        ...
        <button type="submit" v-if="show_inputs" class="btn btn-primary" id="btnGuardar">Guardar</button>
    </form>
</div>
