...
class SolicitudController extends Controller
{
    ...
    public function guardar(Request $request)
    {
        ...
        //$Solicitud -> id_solicitud = $request->input('id_solicitud');
        //$Solicitud -> id_categoria = $request->input('id_categoria');
        $solicitud_subcategoria->id_solicitud = $id_solicitud;
        $solicitud_subcategoria->id_subcategoria = $request->input('subcategoria');      
        $solicitud_subcategoria -> save();

        $id_solicitudsub = $solicitud_subcategoria->id;
        return $id_solicitudsub;
